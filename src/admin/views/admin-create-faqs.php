<div class="wrap t201plugin">
   ...
   <div class="tbox-body">
      <form name="faqs_add_form" id="faqs_add_form" method="post">
         <?php wp_nonce_field('faqs_add_action', 'faqs_add_nonce'); ?>
         <input type="hidden" name="action" value="page_add_new_faqs">
         ...
         <table class="form-table">
            <tr valign="top">
               ...
               <td>
                  <input type="text" id="name" name="name" placeholder="FAQ's Name" class="regular-text" required>
               </td>
            </tr>
         </table>
