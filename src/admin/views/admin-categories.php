<?php
$categories_list_table = new \faqs\FaqsCategoriesListTable();
...
<div class="wrap t201plugin">
    ...
    <div style="display:flex; gap:20px; align-items:flex-start; flex-wrap:wrap;">
        <div class="tbox" style="flex:1; min-width:320px;">
        ...
        <div class="tbox" style="flex:1.5; min-width:420px;">
            <div class="tbox-heading">
                <h3>All Categories</h3>
            </div>
            <div class="tbox-body">
                <form method="get">
                    <input type="hidden" name="page" value="<?php echo esc_attr(isset($_GET['page']) ? sanitize_text_field(wp_unslash($_GET['page'])) : 'faqs-categories'); ?>">
                    <?php $categories_list_table->search_box(__('Search Categories', 'faqs'), 'faqs-categories'); ?>
                    <?php $categories_list_table->display(); ?>
                </form>
            </div>
        </div>
    </div>
